...
for epoch = 1:maxepoch
    ...
    for batch = 1:numbatches
        ...
        err= err +  1/N*sum(sum( (data(:,1:end-1)-dataout).^2 )); %每一次迭代均方误差之和
    end
    train_err(epoch)=err/numbatches; %每一次迭代每一批数据均方误差之和
    ...
    test_err(epoch)=err/testnumbatches;   %每一次迭代每一批数据均方误差之和
